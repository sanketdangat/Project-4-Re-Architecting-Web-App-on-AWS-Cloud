...
```sh
vprofile-rds-mysql.cerpkwphjpfj.us-east-1.rds.amazonaws.com
```
...
- SSH into `mysql-client` instance. We can check mysql version
```sh
mysql -V
```
...
```sh
mysql -h vprofile-rds-mysql.cerpkwphjpfj.us-east-1.rds.amazonaws.com -u admin -p<db_password>
...
```sh
git clone https://github.com/sanketdangat/vprofileproject-all.git
cd vprofileproject-all
git checkout aws-Refactor
cd src/main/resources
mysql -h vprofile-rds-mysql.cerpkwphjpfj.us-east-1.rds.amazonaws.com -u admin -padvPtIYOfqGe4T41MUXk accounts < db_backup.sql
mysql -h vprofile-rds-mysql.cerpkwphjpfj.us-east-1.rds.amazonaws.com -u admin -padvPtIYOfqGe4T41MUXk accounts
show tables;
```
...
```sh
RDS:
vprofile-rds-mysql.cerpkwphjpfj.us-east-1.rds.amazonaws.com:3306
ActiveMQ: amqps://b-9a184028-e9a6-49d8-8a4c-6856afe14b38.mq.us-east-1.amazonaws.com:5671
ElastiCache:
vprofile-elasticache-svc.kpitos.cfg.use1.cache.amazonaws.com:11211
```
...
Application tags: Project:vprofile
Platform: Tomcat
